...
{
    // Temukan pesanan berdasarkan ID dengan relasi
    ...
    {
        $menus = Menu::all();
        $orderItems = $order->orderItems()->with('menu')->get(); // Ambil item pesanan untuk ditampilkan di form
        return view('orders.edit', compact('order', 'menus', 'orderItems'));
    }
